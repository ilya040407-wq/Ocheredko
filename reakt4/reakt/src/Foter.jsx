...
const Foter = () => {
  ...
  return (
    <footer>
      <div className="site-footer bg-yellow-600">
        <img
          src={LOGO}
          alt="Логотип"
        ...
        <button
          className="rounded text-green-700 hover:text-green-400 text-base sm:text-xl bg-yellow-500 hover:bg-gray-700 h-[40px] sm:h-[45px] px-3"
